...
import type {
  IRecoveryAccount,
  IRecoveryAccountInterface,
} from "../../../src/interfaces/IRecoveryAccount";
...
export class IRecoveryAccount__factory {
  static readonly abi = _abi;
  static createInterface(): IRecoveryAccountInterface {
    return new Interface(_abi) as IRecoveryAccountInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IRecoveryAccount {
    return new Contract(address, _abi, runner) as unknown as IRecoveryAccount;
  }
}
